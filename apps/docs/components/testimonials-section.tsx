...
export default function TestimonialsSection() {
	...
	const testimonials = [
		{
			quote:
				"The type safety in Mapwise saved us weeks of debugging. The React hooks are intuitive and the performance is outstanding.",
			name: "Jamie Marshall",
			company: "Senior Frontend Engineer, GeoTech",
			image:
		...
		{
			quote:
				"Mapwise has revolutionized how we build geospatial dashboards. The headless architecture gives us complete control over the UI.",
			name: "Sarah Chen",
			company: "CTO, UrbanAlytics",
			image:
		...
		{
			quote:
				"The plugin system is a game-changer. We easily built custom measuring and drawing tools that integrated perfectly with our app.",
			name: "Marcus Rodriguez",
			company: "Lead Developer, MapFlow",
			image:
