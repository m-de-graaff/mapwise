	...
	const cards = [
		{
			...
			description: "Step-by-step guides to integrating Mapwise\ninto your React application.",
			image: "/modern-dashboard-interface-with-data-visualization.jpg",
		},
		{
			title: "Core Concepts",
			description: "Deep dive into the controller, layer registry,\nand event system.",
			image: "/analytics-dashboard.png",
		},
		{
			title: "API Reference",
			description: "Detailed type definitions, hooks,\nand component documentation.",
		...
		<div className="w-full border-b border-border flex flex-col justify-center items-center">
			...
			<div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-border flex justify-center items-center gap-6">
				<div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
					<Badge
						icon={
							<div className="w-[10.50px] h-[10.50px] outline outline-[1.17px] outline-foreground outline-offset-[-0.58px] rounded-full" />
						}
						text="Documentation"
					/>
					...
					<div className="self-stretch text-center text-muted-foreground text-base font-normal leading-7 font-sans">
						Comprehensive guides, API references, and detailed examples
						<br />
						...
						{cards.map((card, index) => {
							...
							return (
								<div
									...
									// biome-ignore lint/a11y/useSemanticElements: Complex layout
									role="button"
									tabIndex={0}
								...
								>
									<div
										className={`w-full h-0.5 bg-border/20 overflow-hidden ${isActive ? "opacity-100" : "opacity-0"}`}
									>
										<div
											key={animationKey}
