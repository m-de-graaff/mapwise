			...
			<div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
				<div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
					...
					<div className="text-muted-foreground text-sm font-medium leading-[18px] font-sans">
						Mapping made rigorous
					</div>

					{/* Social Media Icons */}
					<div className="flex justify-start items-start gap-4 text-foreground">
						{/* Twitter/X Icon */}
				...
				<div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
					...
					<div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
						...
						<div className="flex flex-col justify-end items-start gap-2">
							<div className="text-foreground text-sm font-normal leading-5 font-sans cursor-pointer hover:text-foreground/80 transition-colors">
								Core
							</div>
							<div className="text-foreground text-sm font-normal leading-5 font-sans cursor-pointer hover:text-foreground/80 transition-colors">
								UI Library
					...
					{/* Community Column */}
					<div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
						<div className="text-muted-foreground/70 text-sm font-medium leading-5 font-sans">
							Community
						</div>
					...
					<div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
						...
						<div className="flex flex-col justify-center items-center gap-2">
							<div className="self-stretch text-foreground text-sm font-normal leading-5 font-sans cursor-pointer hover:text-foreground/80 transition-colors">
								Documentation
							</div>
							<div className="self-stretch text-foreground text-sm font-normal leading-5 font-sans cursor-pointer hover:text-foreground/80 transition-colors">
								API Reference
