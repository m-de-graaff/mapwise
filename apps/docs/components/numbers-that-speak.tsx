...
const NumbersThatSpeak: React.FC<NumbersThatSpeakProps> = ({
	...
	// Placeholder logic
	const imgSchedule = "https://placehold.co/431x271/f5f5f5/e0e0e0?text=Chart+Area";
	const _imgYAxisLine = "https://placehold.co/295x17/transparent/transparent";
	const _imgYAxisLine1 = "https://placehold.co/295x13/transparent/transparent";
	const _imgYAxisLine2 = "https://placehold.co/295x13/transparent/transparent";
															...
															>
																...
																>
																	{["500k", "300k", "200k", "100k", "0"].map((label, index) => (
																		<div
																			// biome-ignore lint/suspicious/noArrayIndexKey: Static legend values
																			key={index}
																			style={{
																				display: "flex",
																				gap: "6.261px",
