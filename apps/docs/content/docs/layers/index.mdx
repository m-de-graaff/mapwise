...
| **WMTS** | [`createWmtsRasterLayer`](/docs/layers/factories#createwmtsrasterlayer) | OGC Web Map Tile Service. |
...
| **Terrain** | [`createTerrainLayer`](/docs/layers/factories#createterrrainlayer) | 3D terrain mesh. |
